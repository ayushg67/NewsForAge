...
#ifndef NEWSFORAGE_SWIFT_H
#define NEWSFORAGE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NewsForAge",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@class NSData;
/// Streaming RSS 2.0 parser built on <code>XMLParser</code>. Extracts title, description,
/// link, publish date and a thumbnail (<code>media:thumbnail</code> or <code>media:content</code>).
SWIFT_CLASS("_TtC10NewsForAge9RSSParser")
